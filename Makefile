...
bin/app: package/src/app.c bin/display.o bin/alsa.o bin/metronome.o bin/input.o bin/menu.o bin/tone.o bin/libfft.o bin/gdisplay.o bin/fileFormat.o bin/fileRead.o bin/find_freq.o bin/lowpass.o
	$(CC) $(CFLAGS) $^ -o $@ $(LIBS)
